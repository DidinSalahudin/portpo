    ...
    return Column(
      ...
      children: const [
        ...
        WorkCustomData(
          ...
          subTitle: "The Complete 2020 Flutter + Dart Winter Development Bootcamp at LCO Training Center,\nJaipur, Rajasthan (302017), Covering all the fundamental concepts for Flutter development",
        ...
        WorkCustomData(
          ...
          subTitle: "Working as a mentor in HakinCode organization for Flutter CodeAsylums application \n where I can utilize my skills and be an asset to the organization",
          duration: "Sep 2020 - Oct 2020",
        ),
        WorkCustomData(
          title: "Flutter Intern at Mind Sports League | Gurgaon In",
          subTitle: "Building world class Poker Learning platform. Poker Sports League is India’s first poker league is to sportify the game of poker through a unique, team based format",
