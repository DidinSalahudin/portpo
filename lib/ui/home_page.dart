                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Flutter-Blog-App-using-Firebase");
                                        },
                                        projectDesc: "A blog application using Flutter and firebase, In this project implement Firebase CURD operation, User can add post as well see all the post.",
                                      ...
                                      FeatureProject(
                                        ...
                                        projectDesc: "In this app you can predict the gender with the help of name and probability of that name.",
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/News-Hours-Apps-Using-Rest-API");
                                        },
                                        projectDesc: "complete news Application using rest API API link- https://newsapi.org, you can get all news.",
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Flutter-wallpaper-App-using-Firebase");
                                        },
                                        projectDesc: "Flutter Wallpaper application using firebase as a backend with a cool animation, it show the all images that are store in firebase firestore.",
                                      ...
                                      FeatureProject(
                                        ...
                                        projectDesc: "A flutter package which help developer in creating a onboarding screens of their app.",
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Flutter-Neumorphic-Calculator-UI");
                                        },
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Flutter-Web-SolMusic-Landing-Page");
                                        },
                                        projectDesc:
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Flutter-Online-Food-Order-App-UI");
                                        },
                                        projectDesc:
                                            "A nicer look at your GitHub profile and repo stats. Includes data visualizations of your top languages, starred repositories, and sort through your top repos by number of stars, forks, and size.",
                                      ...
                                      FeatureProject(
                                        ...
                                        ontab: () {
                                          method.launchURL("https://github.com/champ96k/Netflix-Web-Clone-Using-Flutter");
                                        },
                                        projectDesc:
                                            "A nicer look at your GitHub profile and repo stats. Includes data visualizations of your top languages, starred repositories, and sort through your top repos by number of stars, forks, and size.",
